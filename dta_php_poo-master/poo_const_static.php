...
class Auteur  {
    ...
    private static $COUNT = 0;   // static est une proprieté de classe
    ...
    function __construct($firstName, $lastName) {
        ...
        self::incrementCounter();  // self permet d'acceder au proprieté static de la classe
    }    
...
Auteur::displayCounter();  // ::  permet d'appeler une instance static
