...
function choix()
{
document.location.href="http://private/HackatonV2/comparateuressai3.php"; 
}
</script>
<script type="text/javascript">
function choix_alternatif()
{
document.location.href="http://private/HackatonV2/comparateuressai4.php"; 
}
function choix_final()
{
document.location.href="http://private/HackatonV2/comparateuressai5.php"; 
}
</script>
    </head>
    <body>
     ...
     <?php $db = new PDO('mysql:host=localhost;dbname=Hackaton;charset=utf8', 'phpmyadmin', 'root');
        $requete = "SELECT * from Livres_pretes where id_mediateque = 1 or id_mediateque = 2 or id_mediateque = 3;";
            ...
            <td> 
              <p>
                ...
                else if ($vide == 1)
                {
                  ...
                  $livres2 = $donnees['nombre_de_livres'];
                  $cd2 = $donnees['nombre_cd'];
                  $films2 = $donnees['nombre_films'];
                  $vide = 2;
                }
                else 
                {
                  $livres3 = $donnees['nombre_de_livres'];
                  $cd3 = $donnees['nombre_cd'];
                  $films3 = $donnees['nombre_films'];
...
<script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Catégories', 'Saint-Etienne', 'Roanne', 'Saint-Chamond'],
          ['Livres', parseInt('<?php echo $livres; ?>'), parseInt('<?php echo $livres2; ?>'), parseInt('<?php echo $livres3; ?>')],
          ['Films', parseInt('<?php echo $films; ?>'), parseInt('<?php echo $films2; ?>'), parseInt('<?php echo $films; ?>')],
          ['cd', parseInt('<?php echo $cd; ?>'), parseInt('<?php echo $cd2; ?>'), parseInt('<?php echo $cd; ?>')]
        ]);

        var options = {
          chart: {
            title: 'Comparaison de biens pretes',
          }
        };
                  ...
                  <tr>
                    ...
                    <th scope="col" colspan="3">
                      ...
                      <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="inlineRadio4">Livre Prêtés </label>
                      </div>
                      <div class="form-check form-check-inline">
                      ...
                      <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="inlineRadio7">Inscrits</label>
                      </div>
                      <div class="form-check form-check-inline">
                ...
                <tbody>
                  <tr>
                    <th scope="row">Villes
                      ...
                      <div class="form-check">
                        <input type="checkbox" name="toto" value="toto" onClick="choix_alternatif();" checked >
                        <label class="form-check-label" for="exampleRadios2">
                          Roanne
                        </label>
                      </div>
                      <div class="form-check">
                        <input type="checkbox" name="toto" value="toto" onClick="choix_final();" checked />
    ...
    <div id="columnchart_material" style="width: 700px; height: 400px;"></div>
                    ...
                    <td id="tablegraphique">
                          ...
                          <div class="form-check" id="tablegraphique">
                            ...
                            <input class="form-check-input" type="checkbox" name="tutu" value="tutu" onClick="choix_final();"/>
                            <br>
