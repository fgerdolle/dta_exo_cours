...
document.location.href="http://private/HackatonV2/comparateuressai4.php"; 
    ...
    <body>
     ...
     <?php $db = new PDO('mysql:host=localhost;dbname=Hackaton;charset=utf8', 'root', 'Scorpion131188');
  ...
  <script type="text/javascript">
    ...
    function drawChart() {
      var data = google.visualization.arrayToDataTable([
        ...
        ['livres', parseInt('<?php echo $livres; ?>'), "#b87333"],
        ["cds", parseInt('<?php echo $cd; ?>'), "silver"],
        ["films", parseInt('<?php echo $films; ?>'), "color: #e5e4e2"]
      ]);
      ...
      var options = {
        title: "Nombre d'items dans les differents supports",
        width: 600,
        height: 400,
        bar: {groupWidth: "95%"},
        ...
        <div class="container">
            <div class="row">
              ...
              <table class="table table-borderless "  id="tableone">
                  ...
                  <tr>
                    ...
                    <th scope="col" colspan="3">
                      ...
                      <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="inlineRadio6">Supports Medias </label>
                      </div>
                      <div class="form-check form-check-inline">
                      ...
                      <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="inlineRadio8"> Accesibilités</label>
                      </div>
                    </th>
                ...
                <tbody>
                  <tr>
                    <th id="thville" scope="row">Villes
                      ...
                      <div class="form-check">
						          <input type="checkbox" name="toto" value="toto" onClick="choix_alternatif();" />
...
<div id="columnchart_values" style="width: 700px; height: 400px;"></div>
                    ...
                    <td id="tablegraphique">
                          ...
                          <div class="form-check" id="tablegraphique">
                            ...
                            <input class="form-check-input" type="checkbox" name="tutu" value="tutu" onClick="choix();"/>
                            <br>
