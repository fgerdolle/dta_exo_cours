...
document.location.href="http://private/HackatonV2/comparateuressai5.php"; 
    ...
    <body>
     ...
     <?php $db = new PDO('mysql:host=localhost;dbname=Hackaton;charset=utf8', 'phpmyadmin', 'root');
        $requete = "SELECT * from Livres_pretes where id_mediateque = 1 or id_mediateque = 2;";
...
<script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Catégories', 'Saint-Etienne', 'Roanne'],
          ['Livres', parseInt('<?php echo $livres; ?>'), parseInt('<?php echo $livres2; ?>')],
          ['Films', parseInt('<?php echo $films; ?>'), parseInt('<?php echo $films2; ?>')],
          ['cd', parseInt('<?php echo $cd; ?>'), parseInt('<?php echo $cd2; ?>')]
        ]);
                ...
                <tbody>
                  <tr>
                    <th scope="row">Villes
                      ...
                      <div class="form-check">
                       <?php echo '<input type="checkbox" name="toto" value="toto" onClick="choix_final();" />'; ?>
